browser.on("init", function () {
    ...
    this.tweetIcon.addEventListener("click", () => {
        let domain = (this.currentUrl && new URI(this.currentUrl).host) || "devsysteme.fr";
        let path = "https://www.devsysteme.fr";
        ...
        let url = encodeURIComponent("https://github.com/beuvelet");
